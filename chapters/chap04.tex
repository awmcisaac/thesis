...
Shuffling frame approach is supported by previous probing efforts for video datasets, e.g.~\citet{sevilla-lara2021temporal}
\begin{table}[htpb]
    \centering
...
\subsection{VideoCLIP STAR results}
\label{sec:videoclip}
...
Validation sequence only switch before/after in statement: 41.91 \\
...
average video time is %TODO: avg video time.
